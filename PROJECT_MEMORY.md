...
- Verification after the catalog-sync implementation: `npm run verify` passed (54 shared/report assertions, 59 Brand View assertions, and the full production build). Pending: commit, deploy, and perform a signed-in production seed with both DataDoe organisations.
